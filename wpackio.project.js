...
module.exports = {
	// Project Identity
	appName: 'cpNotificationBars', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'cp-notification-bars', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'cpNotificationBars',
		author: 'Mission Lab',
		license: 'GPL-3.0',
